          ...
          <div className="flex w-full px-16 rounded-xl gap-5 justify-between">
            <div className="flex w-full flex-col">
              <table className="bg-slate-500 w-full rounded-md">
                <thead className="bborder bg-blue-500 text-left  rounded-t-xl rounded-md">
                ...
                <tbody>
                  {cartContext.cartItems.map((product) => {
                    return (
                      <tr className="bg-blue-100 [&>td]:p-2 [&>td]:font-inter [&>td]:text-sm [&>td]:font-medium">
                        <td className="w-32">
                          <img
              ...
              <div className="flex w-full justify-end py-3">
                <button
                  ...
                  className="bg-red-600 hover:bg-red-600/50 rounded-md py-2 px-3 text-sm font-semibold text-white"
                >
                  Limpar carrinho
                </button>
              </div>
            ...
            <div className="flex flex-col w-1/4">
              <div className="bg-blue-100 flex flex-col justify-center items-center">
                <span className="font-semibold text-xl text-white bg-blue-500 p-2 rounded-t-md w-full">
                  Resumo
                </span>
                ...
                <span className="font-inter font-normal text-sm pb-2">
                  {" "}
                  10x de R${" "}
                  {String(
              ...
              <button className="bg-green-600 p-3 rounded-md mt-3 font-inter font-semibold text-sm text-white">
                Finalizar compra
              </button>
            </div>
          </div>
